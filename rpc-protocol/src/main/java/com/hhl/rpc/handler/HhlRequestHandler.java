...
@Slf4j
public class HhlRequestHandler extends SimpleChannelInboundHandler<HhlRpcProtocol<HhlRpcRequest>> {

    private final Map<String, Object> rpcServiceMap;

    public HhlRequestHandler(Map<String, Object> rpcServiceMap) {
